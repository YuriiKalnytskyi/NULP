      ...
      <div className={'nawContainer'}>
        <div className={'componentContainer'}>
          ...
          {component.map((value, index) => (
            ...
            >
              <NawComponent ing={value.img} text={value.name} state={componentState} naw={naw} />
            </div>
          ))}
        </div>
        <div className={'componentContainer'}>
          ...
          >
            <div className={'naw'}>
              <NawComponent ing={helpImd} text={t('Help')} state={componentState} naw={naw} />
            </div>
          </a>
        </div>
        ...
        <div className={'componentContainer2'}>
          <div className={'line2'} />
          <div onClick={logout} className={'naw'}>
            <NawComponent ing={logautImg} text={t('GoOut')} state={componentState} naw={naw} />
          </div>
        </div>
      </div>
    </div>
