      ...
      >
        <div className={"updateUserContainer"}>
          ...
          <div className={"updateContainer2"}>
            ...
            {
              component === 'teaching' ?  <div className={"updateInputContainer2"}>

                <div className={"updateTitle"}
                     style={{ marginBottom: "30px" }}
                >Урок № {value?.lesson}</div>

                <div className={"updateTitle"}
                     style={{ textAlign: "center" }}
                >{value?.description}</div>
              </div> :<div className={"updateInputContainer2"}>
            ...
            <div className={"updateBtnContainer"}>
              <button onClick={deleteValue} className={"updateBtn"}>Видалити</button>
            </div>
